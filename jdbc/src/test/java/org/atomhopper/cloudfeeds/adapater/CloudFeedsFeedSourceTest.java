 ...
 */
public class CloudFeedsFeedSourceTest {
    ...
    private final String MULTI_CAT = "+tid:1234+Cat2";
    private final String AND_CAT = "(AND(cat=tid:1234)(cat=cat2))";
    private final String OR_CAT = "(OR(cat=tid:1234)(cat=cat2))";
    private final String NOT_CAT = "(NOT(OR(cat=tid:1234)(cat=cat2)))";
